...
export default function BoxDetails() {
  ...
  return (
    <GestureHandlerRootView style={styles.container}>
      ...
      {/* Conditionally render Box Description if it's not empty */}
      {boxDescription ? (
        <>
      ...
      <Text style={styles.title}>Items in Box:</Text>
      ...
      <View style={styles.container_r}>
        <TouchableOpacity
          ...
          onPress={() => router.push(`/items/add?boxId=${id}`)}
        >
      ...
      >
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <QRCode value={id} size={200} getRef={(c) => (qrCodeRef = c)} />
