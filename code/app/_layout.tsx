...
import {Image, TouchableOpacity, View, StyleSheet, Text, KeyboardAvoidingView, Platform} from "react-native";
        ...
        {!hideNavBarRoutes.includes(currentRoute) && (
            <View style={styles.navbar}>
              <TouchableOpacity style={styles.navItem} onPress={() => router.push('/')}>
                <Ionicons name="cube-outline" size={22} color={getNavItemStyle("").color} />
              ...
              <TouchableOpacity style={styles.navItem} onPress={() => router.push('/categories')}>
                <Ionicons name="list-outline" size={22} color={getNavItemStyle("categories").color} />
                <Text style={[styles.navText, getNavItemStyle("categories")]}>Categories</Text>
              </TouchableOpacity>

              <TouchableOpacity style={styles.navItem} onPress={() => router.push('/items')}>
                <Ionicons name="pricetag-outline" size={22} color={getNavItemStyle("items").color} />
                <Text style={[styles.navText, getNavItemStyle("items")]}>Items</Text>
              </TouchableOpacity>
            </View>
        )}
        </KeyboardAvoidingView>
